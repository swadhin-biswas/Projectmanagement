  ...
  return app.group("/students", (app) => {
    ...
    return app
      ...
      .get("/profile", {
        response: {
          200: t.Object({
            ...
            data: t.Object({
              ...
              currentSession: t.Optional(t.Object({
                _id: t.String(),
                name: t.String(),
                startDate: t.String(),
                endDate: t.String(),
        ...
        return studentController.getStudentProfile(user.id);
      })
      ...
      .get("/deadlines", {
        ...
        return studentController.getStudentDeadlines(user.id);
      })
      ...
      .post("/submit-report", {
        ...
        return studentController.submitReport(user.id, body);
      })
      ...
      .get("/messages", {
        ...
        return studentController.getStudentMessages(user.id);
      })
      ...
      .put("/messages/:messageId/read", {
        ...
        return studentController.markMessageAsRead(user.id, params.messageId);
      })
      ...
      .group("/results", (app) => {
        return app
          .get("/", {
            response: {
              200: t.Object({
                ...
                data: t.Array(t.Object({
                  ...
                  supervisor: t.Optional(t.Object({
                    name: t.String()
                  }))
                }))
              }),
            ...
            return studentController.getStudentResults({ user });
          })
          ...
          .get("/:resultId", {
            ...
            return studentController.getResultDetail({ params, user });
          });
      });
  });
}
