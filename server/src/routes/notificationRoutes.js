    ...
    return app
      ...
      .get("/", {
        ...
        try {
          ...
          return await getNotifications({ user, query });
        } catch (error) {
      ...
      .put("/read-all", {
        ...
        try {
          ...
          await authorize()(user);
          await markAllAsRead(user.id, query);
      ...
      .put("/preferences", {
        body: t.Object({
          email: t.Optional(t.Object({
            ...
            frequency: t.String({ enum: ["immediate", "daily", "weekly"] }),
          })),
          push: t.Optional(t.Object({
            enabled: t.Boolean(),
            types: t.Array(t.String()),
          })),
          inApp: t.Optional(t.Object({
            types: t.Array(t.String()),
